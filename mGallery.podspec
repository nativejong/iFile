...
Pod::Spec.new do |s|
    ...
    s.source           = { :git => "https://github.com/nativejong/iFile.git", :tag => s.version }
    s.social_media_url = 'https://twitter.com/artsy'

    s.platform     = :ios, '7.0'
    s.requires_arc = true
    
    s.public_header_files = "iFile.framework/Headers/*.h"
    s.source_files = "iFile.framework/Headers/*.h"
    s.vendored_frameworks = "iFile.framework"
